...
function theme_enqueue_scripts() {
    ...
    wp_enqueue_style( 'Style', get_template_directory_uri() . '/style.css?v=0.1' );
    ...
    wp_enqueue_script( 'CommonJS', get_template_directory_uri() . '/js/dtourism/common.js', array(), '1.0.1', true );
    // Load if frontpage
    // if(is_front_page()){ 
